...
<div class="table-responsive">
	<table class="table table-striped table-bordered table-hover">
		...
		<tr class="<?php echo cycle(array('bg1','bg'));?>">
			...
			<?php }if($this->router->fetch_method()=='memberList'){?>
			<a href="<?php echo $site_url.$active_controller;?>/set_member_status/<?php echo $row['id']?>" class="<?=strtolower($row[$field])?>"><?php echo $status_title; ?> </a>
			<?php }?>
			</td>
		   ...
		   <?php elseif($field=='link'): ?>
			...
			<?php if($gatype === 'edit' || $gatype === 'memberEdit'|| $gatype === 'walletEdit'):?> 
			...
			<?php elseif($gatype === 'del' || $gatype ==='memberDel' ):?>
			...
			<?php elseif($gatype === 'manage' || $gatype ==='manage' ):?>
			<a href="<?=$site_url.$active_controller.'/'.$gactn.'/'.$row['id'] ?>" title="Click here for credit"><span class="action_btn btn-success"><i class="fa fa-cog"></i></span></a>
			
			<?php elseif($gatype === 'sms' || $gatype ==='memberSms' ):?>
			...
			<?php elseif($gatype === 'share' || $gatype ==='share' ):?>
			<a href="<?=$site_url.$active_controller.'/'.$gactn.'/'.$row['id'] ?>" title="Click here for login" ><span class="action_btn btn-primary"><i class="fa fa-share"></i></span></a>
