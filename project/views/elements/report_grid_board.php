...
<div class="table-responsive">
	<table class="table table-striped table-bordered table-hover">
		...
		<?php $quantity = 0; $discount = 0; $loss_profit = 0; foreach($records as  $row): $quantity=$quantity+$row['quantity']; $discount=$discount+$row['discount']; $loss_profit=$loss_profit+$row['loss_profit']; ?>
		...
		<?php endif ?>
		<tr><td>#</td><td colspan="3" align="center"><b>Total</b></td><td><?=$quantity;?></td><td></td><td><?=$discount;?></td><td><?=$loss_profit;?></td><td></td></tr>
		</tbody>
	</table>								
