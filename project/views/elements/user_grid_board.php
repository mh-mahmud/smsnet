	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tr class="<?php echo cycle(array('bg1','bg'));?>">
		   ...
		   <?php elseif($field=='link'): ?>
			...
			<?php elseif($gatype === 'userBilling' || $gatype ==='userBilling' ):?>
			<a href="<?=$site_url.$active_controller.'/'.$gactn.'/'.$row['id'] ?>" title="Click here for user Billing" ><span class="action_btn btn-primary"><i class="fa fa-money"></i></span></a>
