	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" action="<?=$site_url.$active_controller;?>/walletEdit/<?=$id;?>" method="post">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="form-control" name="deposit_amount" value="<?=set_value('deposit_amount',$deposit_amount); ?>"/>
				...
				<div class="form-group">
					...
					<div class="field">
						<select class="chosen form-control" name="curency">
							...
							<?php echo html_options($curency_options,set_value('curency',$curency)) ;?>
						</select>
