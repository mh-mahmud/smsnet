                ...
                <div class="panel-heading">
                    ...
                    <div class="box-tools pull-right">
                        <div class="box-tools pull-right">
                            ...
                            <a href="<?= $site_url . $link_action; ?>"  class="btn btn-primary btn-xs pull-right" style="margin-right: 5px; margin-top: 5px;"><i class='fa fa-plus'></i> New Transfer</a>
                        </div>				
                    </div>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php $this->load->element('deposit_grid_board'); ?>
                        </div>
                    </div>
                </div>
            </div>
