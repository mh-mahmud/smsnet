                ...
                <div class="panel-heading">
                    ...
                    <div class="box-tools pull-right">
                        <div class="box-tools pull-right">
                            ...
                            <a href="<?= $site_url . $link_action; ?>"  class="btn btn-primary btn-xs pull-right" style="margin-right: 5px; margin-top: 5px;"><i class='fa fa-plus'></i> Wallet History</a>
                        </div>				
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <td>Total Received Amount : <?= $walletSummery[0]['total_received_amount']; ?></td>
                                    <td>From : <?= $walletSummery[0]['fromdate']; ?></td>
                                    <td>To : <?= $walletSummery[0]['todate']; ?></td>
                                </tr>
                            </table>							
