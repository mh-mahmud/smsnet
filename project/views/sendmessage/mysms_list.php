<form id="ajax_submit" role="form" action="<?=$site_url.$active_controller.'/mysms';?>" method="post">
	<div class="row">
		<div class="col-lg-12">
						...
						<div class="col-lg-12">
							...
							<table class="table table-bordered">
								<tr>
									...
									<td><input type="text" class="form-control lg" name="destmn" placeholder="number" value="<?php echo htmlspecialchars($_POST['destmn']); ?>"/></td>
