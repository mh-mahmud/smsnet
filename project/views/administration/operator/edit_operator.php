	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" action="<?=$site_url.$active_controller;?>/operatoredit/<?=$id;?>" method="post">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="form-control" name="short_name" value="<?=set_value('short_name',$short_name); ?>"/>
				...
				<div class="form-group">
					<text>Prefix :</text>
					<div class="field">
						<input type="text" class="form-control" name="prefix" value="<?=set_value('prefix',$prefix); ?>"/>
				...
				<div class="form-group">
					...
					<text>Ton :</text>
					<div class="field">
						<input type="text" class="form-control" name="ton" value="<?=set_value('ton',$ton); ?>"/>
				...
				<div class="form-group">
					<text>Npi :</text>
					<div class="field">
						<input type="text" class="form-control" name="npi" value="<?=set_value('npi',$npi); ?>"/>
