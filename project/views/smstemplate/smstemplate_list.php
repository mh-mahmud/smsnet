				...
				<div class="panel-heading">
					<i class="fa fa-table"></i><?php echo $page_title; ?>
						<div class="box-tools pull-right">
							...
							<a href="<?= $site_url . $link_action; ?>"  class="btn btn-primary btn-xs pull-right" style="margin-right: 5px; margin-top: 5px;"><i class='fa fa-plus'></i> New Template</a>
						</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<table class="table table-bordered">
								<tr>
									<td><input type="text" class="form-control lg" name="title" placeholder="title" value="<?php echo htmlspecialchars($_POST['title'])  ; ?>"/></td>
