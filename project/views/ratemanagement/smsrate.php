	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" action="<?=$site_url.$active_controller;?>/defaultrate" method="post">
							...
							<tr>
								...
								<td  align="center">
									<?php if($this->session->userdata('user_group_id')==2){?>
										<input readonly type="text" id="rate" class="form-control" name="buying_rate<?=$key; ?>" value="<?=set_value('buying_rate',get_buying_rate($val['id'])); ?>"/>
