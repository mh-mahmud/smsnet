            ...
            <div class="panel-body">
                <form role="form" action="<?= $site_url . $active_controller; ?>/edit/<?= $id; ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <select class="form-control" name="id_user_group">
                                ...
                                <?php echo html_options($user_group_options, set_value('id_user_group', $id_user_group)); ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <select class="form-control" name="rate_id">
                                ...
                                <?php echo html_options($rate_options, set_value('rate_id', $rate_id)); ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <select class="form-control" name="billing_type">
                                ...
                                <?php echo html_options($user_type_options, set_value('billing_type', $billing_type)); ?>
                            </select>
                    ...
                    <div class="form-group">
                        <text>MRC/OTC</text>
                        <div class="field">
                            <input type="text" class="form-control" name="mrc_otc" value="<?= set_value('mrc_otc', $mrc_otc); ?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input type="text" class="form-control" name="duration_validity" value="<?= set_value('duration_validity', $duration_validity); ?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input type="text" class="form-control" name="bill_start" value="<?= set_value('bill_start', $bill_start); ?>"/>
