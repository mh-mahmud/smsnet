<div id="page-inner">
		...
		<div class="col-md-3 col-sm-12 col-xs-12">
			<div class="panel panel-primary text-center no-boder bg-color-green">
				<div class="panel-body">
					...
					<h3><?php if($creditBalance['credite_balance']){echo number_format((float)$creditBalance['credite_balance'], 2, '.', '');}else{echo 0;}?></h3>
				</div>
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<?php foreach($recentBill as $key=>$val){?>
								<!--tr>
									...
									<td align="right"><?//=$val['credite_balance'];?></td>
	...
	<div class="row">		
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<span>SMS STATUS OF MY CLIENT</span>
		</span>
				</div> 
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<?php if($smsreport){ foreach($smsreport as $key=>$val){?>
										<th align="center"><?=$val['status'];?></th>
									<?php }}else{?> 
