		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="form-control" name="reseller_cost_per_unit" value="<?=set_value('reseller_cost_per_unit'); ?>"/>
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="form-control" name="customer_cost_per_unit" value="<?=set_value('customer_cost_per_unit'); ?>"/>
