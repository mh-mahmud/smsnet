	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" action="<?=$site_url.$active_controller;?>/routeadd" method="post">
				...
				<div class="form-group">
					...
					<div class="field">
						<select class="chosen form-control" name="channel_id">
							...
							<?php echo html_options($channel_options,set_value('channel_id')) ;?>
						</select>
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="form-control" name="default_mask" value="<?=set_value('default_mask'); ?>"/>
				...
				<div class="form-group">
					...
					<div class="field">
						<select class="chosen form-control" name="has_mask">
							...
							<?php echo html_options($mask_options,set_value('has_mask')) ;?>
						</select>
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="form-control" name="success_rate" value="<?=set_value('success_rate'); ?>"/>
