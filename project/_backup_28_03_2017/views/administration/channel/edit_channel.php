	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" action="<?=$site_url.$active_controller;?>/channeledit/<?=$id;?>" method="post">
				...
				<div class="form-group">
					...
					<div class="field">
						<select class="form-control" name="channel_type" id="channel_type">
							...
							<?php echo html_options($channel_type_options,set_value('channel_type',$channel_type)) ;?>
						</select>
				...
				<div class="form-group" id="url">
					<text>Url :</text>
					<div class="field">
						<input type="text" class="form-control" name="url" value="<?=set_value('url',$url); ?>"/>
				...
				<div class="form-group" id="password">
					<text>Password :</text>
					<div class="field">
						<input type="text" class="form-control" name="password" value="<?=set_value('password',$password); ?>"/>
				...
				<div class="form-group" id="ip">
					<text>IP :</text>
					<div class="field">
						<input type="text" class="form-control" name="ip" value="<?=set_value('ip',$ip); ?>"/>
				...
				<div class="form-group" id="port">
					<text>Port :</text>
					<div class="field">
						<input type="text" class="form-control" name="port" value="<?=set_value('port',$port); ?>"/>
				...
				<div class="form-group" id="port">
					<text>Mode :</text>
					<div class="field">
						<input type="text" class="form-control" name="mode" value="<?=set_value('mode',$mode); ?>"/>
						<span class="error"></span><?php echo form_error('mode'); ?>
					</div>
				</div>
...
$(document).ready(function() {
	...
	var channel_type = '<?=$channel_edit_type;?>';
		if(channel_type=='HTTP'){
