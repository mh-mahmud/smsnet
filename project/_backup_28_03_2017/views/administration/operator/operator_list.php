<form id="ajax_submit" role="form" action="<?=$site_url.$active_controller;?>/operatorindex" method="post">
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<div class="box-tools pull-right">
						...
						<a href="<?= $site_url . $link_action; ?>"  class="btn btn-primary btn-xs pull-right" style="margin-right: 5px; margin-top: 5px;"><i class='fa fa-plus'></i> New Operator</a>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<table class="table table-bordered">
								<tr>
									<td><input type="text" class="form-control lg" name="full_name" placeholder="full_name" value="<?php echo htmlspecialchars($_POST['full_name']); ?>"/></td>
									<td><input type="text" class="form-control lg" name="short_name" placeholder="short_name" value="<?php echo htmlspecialchars($_POST['short_name']); ?>"/></td>
									<td><input type="text" class="form-control lg" name="prefix" placeholder="prefix" value="<?php echo htmlspecialchars($_POST['prefix']); ?>"/></td>
