					...
					<div class="row">
						<div class="col-lg-12">
							...
							<table class="table table-bordered">
								<tr>
									<td><input type="text" class="form-control lg" name="name" placeholder="name" value="<?php echo $this->session->userdata('name'); ?>"/></td>
									<td width="20%">
										<select class="form-control lg" name="operator_id" id="operator_id">
											<option value="">---- Select Operator -----</option>
											<?php echo html_options($operator_options,$this->session->userdata('operator_id')); ?>	
										</select>									
									</td>									
									<td width="20%">
										<select class="form-control lg" name="channel_type" id="channel_type">
											<option value="">---- Select Channel Type -----</option>
											<?php echo html_options($channel_type_options,$this->session->userdata('channel_type')); ?>	
										</select>									
									</td>									
								...
								<?php $this->load->element('channel_grid_board');?>
							</div>
						</div>
					</div>
				</div>
