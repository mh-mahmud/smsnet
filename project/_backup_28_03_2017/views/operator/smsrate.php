					...
					<table class="table table-striped table-bordered table-hover">
						...
						<?php foreach($operator_options as $key=>$val){?>
							<tr>
								...
								<td  align="center">
									<input type="text" id="rate" class="form-control" name="per_sms_rate<?=$key; ?>" value="<?=set_value('per_sms_rate',$val['per_sms_rate']); ?>"/>
									<span class="error">*</span><?php echo form_error('per_sms_rate'); ?>
								</td>
