					...
					<div class="row">
						<div class="col-lg-12">
							...
							<table class="table table-bordered">
								<tr>
									<td><input type="text" class="form-control lg" name="full_name" placeholder="full_name" value="<?php echo $this->session->userdata('full_name'); ?>"/></td>
									<td><input type="text" class="form-control lg" name="short_name" placeholder="short_name" value="<?php echo $this->session->userdata('short_name'); ?>"/></td>
									<td><input type="text" class="form-control lg" name="prefix" placeholder="prefix" value="<?php echo $this->session->userdata('prefix'); ?>"/></td>
