            ...
            <div class="panel panel-default">
                ...
                <div class="row custom"" >
                    <div class="panel-body">
                        <div>
                            <table class="table table-condensed" class="table table-bordered" border="1" cellspacing="0" bordercolor="#222">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    if (count($billingReport) > 0) {
                                        foreach ($billingReport as $val) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?php if($val['totalSmsOperatorwise'][0]->totalsms){echo $val['totalSmsOperatorwise'][0]->totalsms;}else{echo 0;} ?></td>
                                                <td class="text-center"><?php if($val['totalSmsCountOperatorwise'][0]->totalsmscount){echo $val['totalSmsCountOperatorwise'][0]->totalsmscount;}else{echo 0;} ?></td>
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="3">MRC/OTC: </td>
                                        <td class="text-center"><?php if($billingReport[0]['mrc_otc']){echo number_format($billingReport[0]['mrc_otc'], 2, '.', '');}else{echo 0;} ?></td>
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="3">SD(5%): </td>
                                        <td class="text-center"><?php echo 0; ?></td>
                                        <td class="text-center"><?php echo 0; ?></td>
...
; ?></strong></td>
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="3">SC(1%): </td>
                                        <td class="text-center"><?php echo 0; ?></td>
                                        <td class="text-center"><?php echo 0; ?></td>
...
; ?></strong></td>
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="3">VAT(15%): </td>
                                        <td class="text-center"><?php echo 0; ?></td>
                                        <td class="text-center"><?php echo 0; ?></td>
