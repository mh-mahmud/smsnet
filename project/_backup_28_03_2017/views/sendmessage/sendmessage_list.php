			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<div class="box-tools pull-right">
						...
						<a href="<?= $site_url . $link_action; ?>"  class="btn btn-primary btn-xs pull-right" style="margin-right: 5px; margin-top: 5px;"><i class='fa fa-plus'></i> New Send Message</a>
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<table class="table table-bordered">
								<tr>
									<td width="25%">
									<select class="form-control lg chosen" name="status" id="status">
										<option value="">---- Select Status -----</option>
										<?php echo html_options($status_options,htmlspecialchars($_POST['status'])); ?>	
									</select>									
									</td>
									<td width="25%">
									<select class="form-control lg chosen" name="sms_type" id="sms_type">
										<option value="">---- Select Type -----</option>
										<?php echo html_options($type_options,htmlspecialchars($_POST['sms_type'])); ?>	
									</select>									
									</td>
