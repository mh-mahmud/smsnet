					...
					<div class="row">
						<div class="col-lg-12">
							...
							<table class="table table-bordered">
								...
								<?php $this->load->element('route_grid_board');?>
							</div>
						</div>
					</div>
				</div>
